...
module tb_el_add_load_start;
  ...
  localparam [2:0]   MODE_EL_ADD   = 3'b100;  // final_top mode for element-wise add
  ...
  initial begin
    ...
    // Capture outputs
    fo = $fopen("C:/Users/ASUS/Desktop/acc/data/eltwise_add_out_tb.bin", "wb");
    if (fo == 0) begin
