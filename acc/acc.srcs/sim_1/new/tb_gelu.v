...
module tb_gelu;
	...
	reg           ready_in;
	parameter GELU_MODE = 3'b110; //  gelu模式
	// 实例化 DUT
	final_top dut (
		.clk(clk),
		.rst(rst),
	...
	initial begin
		...
		fd_out = $fopen("C:/Users/ASUS/Desktop/acc/data/gelu_out_tb.bin", "wb");
		if (fd_out == 0) begin
			$display("[ERROR] Cannot open output file: C:/Users/ASUS/Desktop/acc/data/gelu_out_tb.bin");
			$finish;
		end
