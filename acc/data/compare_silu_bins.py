#!/usr/bin/env python3
"""
Compare Verilog SiLU output vs Python golden (bf16).

- TB output:   silu_out_tb.bin
- Python golden: silu_bf16.bin
...
TB_FILE = os.path.join(DATA_DIR, 'silu_out_tb.bin')
GD_FILE = os.path.join(DATA_DIR, 'silu_bf16.bin')
...
def main():
    ...
    # Row-wise relative L2 error for rows [38..41] (0-based)
    if rows is not None:
        ...
        print('Row-wise relative L2 error for rows [38..41] (0-based):')
