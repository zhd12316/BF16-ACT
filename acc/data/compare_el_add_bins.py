#!/usr/bin/env python3
"""
Compare Verilog Elementwise-Add output vs Python golden (bf16).

- TB output:   eltwise_add_out_tb.bin
- Python golden: eltwise_add_bf16.bin
...
TB_FILE = os.path.join(DATA_DIR, 'eltwise_add_out_tb.bin')
GD_FILE = os.path.join(DATA_DIR, 'eltwise_add_bf16.bin')
